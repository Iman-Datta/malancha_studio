      ...
      <div className="relative section-padding py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-sm text-charcoal-400 hover:text-primary transition-colors duration-300 inline-block"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-charcoal-400 leading-relaxed">
                  {contactInfo.address || "North Dumdum, West Bengal, India"}
                </span>
              </li>
          ...
          <div className="flex flex-col">
            ...
            <div className="relative w-full h-44 rounded-xl overflow-hidden border border-white/10 bg-charcoal-800 shadow-md group">
              <iframe
